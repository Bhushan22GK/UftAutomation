RegAppName = "Assurance"
Call Fn_Set_BrowsePage ()
Call Fn_Delete_Cookies()
Call Fn_CreatSapObject

sRelease = "SIT || Assurance || R25 Baseline|| Execution Report"
...
If DataTable.LocalSheet.GetCurrentRow = 1 Then
  ...
  '  DataTable.ImportSheet sRelPath & "\RIL_TTAF\Input\Assurance_Regression_Final_Incident(RQM).xls", "DetailedTestPlan", "Global"
    'DataTable.ImportSheet sRelPath & "\RIL_TTAF\Input\LAB_R21_Assurance_Regression_Pack_Final_change.xls", "DetailedTestPlan", "Global"
  '  DataTable.ImportSheet sRelPath & "\RIL_TTAF\Input\R21_Assurance_CR.xls", "DetailedTestPlan", "Global"
  'DataTable.ImportSheet sRelPath & "\RIL_TTAF\Input\Assurance_TestData_SAPCRM.xls", "DetailedTestPlan", "Global"
  'DataTable.ImportSheet sRelPath & "\RIL_TTAF\Input\Assurance_TestData_PM.xls", "DetailedTestPlan", "Global"
  DataTable.ImportSheet sRelPath & "\RIL_TTAF\Input\ART_Assurance_Config_Mgmt.xls", "DetailedTestPlan", "Global"
