...
# All rights reserved.
#
# This script is used to launch the Administration Tool of SAP Convergent Charging.
#
...
HIGHDEALCLASSES=$HIGHDEAL_LIB/core_admin.jar:$HIGHDEAL_LIB/logging.jar:$HIGHDEAL_LIB/sap.com~tc~logging~java.jar:$HIGHDEAL_LIB/core_chargingplan.jar:$HIGHDEAL_LIB/core_chargingprocess.jar:$HIGHDEAL_LIB/core_client.jar:$HIGHDEAL_LIB/common_message.jar:$HIGHDEAL_LIB/common_util.jar

CLASSPATH=$HIGHDEALCLASSES

# change this variable if you want to select another language
LANGUAGE="-Duser.country=US -Duser.language=en"

JAVA="$SAPCC_JAVA_HOME/bin/java"

exec $JAVA -Dfile.encoding=UTF-8 -classpath $CLASSPATH $LANGUAGE com.highdeal.admin.plus.AdminPlus $*
