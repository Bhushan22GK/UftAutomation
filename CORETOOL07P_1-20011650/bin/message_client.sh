...
# All rights reserved.
#
# This script is used to launch the Message Client program of SAP Convergent Charging.
#
...
exec $SAPCC_JAVA_HOME/bin/java -Dfile.encoding=UTF-8 -classpath $CLASSPATH com.highdeal.messageclient.MessageClient $*
