...
REM
REM This script is used to launch HTTP Client program of SAP Convergent Charging.
REM
...
"%JAVA%" -Dfile.encoding=UTF-8 -classpath %CLASSPATH% com.highdeal.httpclient.HttpClient %1 %2 %3 %4 %5 %6 %7 %8 %9
endLocal
GOTO end
